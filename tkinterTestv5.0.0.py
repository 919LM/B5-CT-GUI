...
class App:
    ...
    def mainMenu(self): 
        ...
        self.LMain.place(y = 20, x = 5)
        self.B1Main = Button(self.master, text = "Week 1 Functions",  command = lambda: [self.week1()])
        self.B1Main.place(y = 60, x = 5)
        self.B2Main = Button(self.master, text = "Week 2 Functions",  command = lambda:[self.week2()])
        self.B2Main.place(y = 100, x = 5)
        self.B3Main = Button(self.master, text = "Week 3 Functions")
        self.B3Main.place(y = 140, x = 5)
